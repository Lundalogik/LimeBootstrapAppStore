lbs.apploader.register('RelationMapHelper', function () {
    var self = this;
    ...
    */
    self.config =  function(appConfig){
            ...
            this.resources = {
                ...
                styles: [], // <= Load styling for the app.
    ...
    */
    self.initialize = function (node, viewModel) {
        lbs.common.executeVba('RelationMap.SetScreenSize, ' + screen.height + ', ' + screen.width);
        return viewModel;
    };
});
