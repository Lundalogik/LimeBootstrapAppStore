...
CREATE PROCEDURE [dbo].[csp_scriptfield_relation_oneToMany]
	...
	@field_localname_no NVARCHAR(128),
	@field_localname_da NVARCHAR(128),
	@field_localname_fi NVARCHAR(128),
	@tab_table NVARCHAR(128),
	@tab_name NVARCHAR(128),
	@tab_localname_sv NVARCHAR(128),
	@tab_localname_en NVARCHAR(128),
	@tab_localname_no NVARCHAR(128),
	@tab_localname_da NVARCHAR(128),
	@tab_localname_fi NVARCHAR(128)
AS
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN TRY
		...
		**********************/
		...
		-- set localname
		UPDATE [string] SET sv = @field_localname_sv, en_us = @field_localname_en, [no] = @field_localname_no, da = @field_localname_da, fi = @field_localname_fi WHERE [idstring] = @localname
		...
		**********************/
		...
		-- set localname
		UPDATE [string] SET sv = @tab_localname_sv, en_us = @tab_localname_en, [no] = @tab_localname_no, da = @tab_localname_da, fi = @tab_localname_fi WHERE [idstring] = @localname
