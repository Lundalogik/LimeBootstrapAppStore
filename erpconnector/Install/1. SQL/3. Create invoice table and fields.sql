...
BEGIN TRY
	...
	BEGIN
		...
		SET @f_localname_no = N'Vår referanse'
		...
		UPDATE [string] SET en_us = N'Invoice Date', sv = N'Fakturadatum', [no] = N'Fakturadato', da = N'Fakturadato', fi = N'Laskutus päivämäärä' WHERE [idstring] = @localname
		...
		UPDATE [string] SET en_us = N'Due Date', sv = N'Förfallodatum', [no] = N'Forfallsdato', da = N'Forfaldsdato', fi = N'Eräpäivä' WHERE [idstring] = @localname
		EXEC [dbo].[lsp_setfieldattributevalue] @@idfield = @idfield, @@name = N'isnullable', @@valueint = 1	--nullable
		EXEC [dbo].[lsp_setfieldattributevalue] @@idfield = @idfield, @@name = N'defaultvalue', @@valueint = null	--default
		...
		UPDATE [string] SET en_us = N'Amount', sv = N'Belopp ex moms', [no] = N'Beløp ex mom', da = N'Beløb', fi = N'Määrä ex ALV' WHERE [idstring] = @localname
		EXEC [dbo].[lsp_setfieldattributevalue] @@idfield = @idfield, @@name = N'newline', @@valueint = 3	--NewLine
		...
		UPDATE [string] SET en_us = N'Total Amount', sv = N'Total Belopp', [no] = N'Totalt Beløp', da = N'Totalbeløb', fi = N'Kokonaismäärä' WHERE [idstring] = @localname
		...
		UPDATE [string] SET en_us = N'Payment Date', sv = N'Betalningsdatum', [no] = N'Betalingsdato', da = N'Betalingsdato', fi = N'Maksupäivä' WHERE [idstring] = @localname
		EXEC [dbo].[lsp_setfieldattributevalue] @@idfield = @idfield, @@name = N'isnullable', @@valueint = 1	--nullable
		EXEC [dbo].[lsp_setfieldattributevalue] @@idfield = @idfield, @@name = N'defaultvalue', @@valueint = null	--default
