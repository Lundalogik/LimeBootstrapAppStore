...
BEGIN TRY
	...
	BEGIN
		...
		UPDATE [string] SET en_us = N'Invoice Row', sv = N'Fakturarad', [no] = N'Fakturarad', da = N'Fakturarække', fi = N'Laskurivi' WHERE [idstring] = @localname
		--CREATE PLURAL NAME
		DECLARE @tempstringid INT

		INSERT INTO [string] (idcategory, sv, en_us, [no], da, fi) 
		VALUES (17, N'Fakturarader', N'Invoice rows', N'Fakturarader', N'Faktura rækker', N'Laskurivit')
		...
		SET @t_localname_da = N'Faktura rækker'
		...
		UPDATE [string] SET en_us = N'Units', sv = N'Antal', [no] = N'Antall', da = N'Enheder', fi = N'Määrä' WHERE [idstring] = @localname
		...
		UPDATE [string] SET en_us = N'Contribution margin', sv = N'Täckningsbidrag', [no] = N'Dekningsbidrag', da = N'Bidragsmargin', fi = N'Kate' WHERE [idstring] = @localname
		...
		UPDATE [string] SET en_us = N'Amount', sv = N'Summa', [no] = N'Sum', da = N'Beløb', fi = N'Summa' WHERE [idstring] = @localname
		...
		UPDATE [string] SET en_us = N'Row ID', sv = N'Rad ID', [no] = N'Rad ID', da = N'Række ID', fi = N'Rivitunnus' WHERE [idstring] = @localname
