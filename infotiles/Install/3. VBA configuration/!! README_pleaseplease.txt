...
4. Run the install sub in the Infotiles.bas


To inactivate the "specific department" functionality, simply change the constant at the top of the "InfoTiles" (VBA) module after importing it to your LIME database.
